...
// Force dynamic so the dashboard (and any list that feeds the create-redirect flow)
// always sees freshly created events immediately on hard refresh or navigation.
